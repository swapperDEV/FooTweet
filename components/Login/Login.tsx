        ...
        <div className={loginStyle.wrapper}>
          <div className={loginStyle.leftSide}>
            ...
            <div className={loginStyle.top}>
              ...
              <p>
                Login to your acc<a>.</a>{" "}
              </p>
              <a className={loginStyle.login}>
                You dont have account?
                <b className={loginStyle.loginBtn}>
            ...
            <div className={loginStyle.bottom}>
              <form>
                ...
                <div className={loginStyle.bottomInfo}>
                  <button onClick={submitBtn} className={loginStyle.button}>
                  ...
                  {resetPass ? (
                    ...
                    >
                      <a className={loginStyle.backButton}>Go back</a>
                    </p>
                  ) : (
                    <>
                      <div>
