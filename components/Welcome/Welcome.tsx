        ...
        <div className={welcomeStyle.leftSide}>
          <div className={welcomeStyle.top}>
            <div className={welcomeStyle.img}>
              <Image src={logo} alt="photo logo" width="80px" height="80px" />
            </div>
            <p>
              The best news from
              <br /> football <a>world</a>{" "}
            </p>
          </div>
          <div>
          ...
          <div className={welcomeStyle.bottom}>
            <div className={welcomeStyle.enter}>Join to us.</div>
            <div className={welcomeStyle.buttonWrapper}>
              <button
                onClick={() => signupRedirect()}
                className={welcomeStyle.button}
              >
                Signup{" "}
              </button>
            </div>
            ...
            <div className={welcomeStyle.loginWrapper}>
              ...
              <button
                ...
                className={welcomeStyle.buttonMini}
              >
                Login{" "}
              </button>
            </div>
