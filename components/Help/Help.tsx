            ...
            <div className={helpStyle.wrapper}>
                <div className={helpStyle.leftSide}>
                    <Image
                        ...
                        height="150"
                    />
                    <p className={helpStyle.bigText}>Need help<a>.</a></p>
                    <p className={helpStyle.smallText}>You found something like <a>bug?</a></p>
                    <p>Our portal is open-source so you can <a>report issue</a> on <a href={'https://github.com/swapperDEV/FooTweet/issues'} target='_blank' rel="noopener noreferrer">github</a></p>
                    <div>
