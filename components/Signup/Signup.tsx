...
export const SignupComponent = () => {
  ...
  const [allUsers, setAllUsers] = useState<UsersType>({ usersList: [] });
        ...
        <div className={signupStyle.wrapper}>
          <div className={signupStyle.leftSide}>
            ...
            <div className={signupStyle.top}>
              ...
              <p>
                Create a account<a>.</a>{" "}
              </p>
              <a className={signupStyle.login}>
                Already have account?
                <b className={signupStyle.loginBtn}>
            ...
            <div className={signupStyle.bottom}>
              <form>
                ...
                <div className={signupStyle.button}>
                  <button onClick={submitSignup} className={signupStyle.submit}>
                    Submit
                  </button>
                </div>
              </form>
