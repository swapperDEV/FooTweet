        ...
        <Wrapper>
            <div className={aboutStyle.wrapper}>
                <div className={aboutStyle.leftSide}>
                    ...
                    height="150"
                    />
                    <p className={aboutStyle.bigText}>About <a>us</a></p>
                    <p className={aboutStyle.smallText}>We try to put all soccer fans to <br/>one <a>social media</a> portal.</p>
                    <div>
                        <div><p>+100</p><a>users</a></div>
                        <div className={aboutStyle.statsCenter}><p>+50</p><a>posts</a></div>
