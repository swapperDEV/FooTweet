...
const toastOptions: ModalOptions = {
  theme: "dark",
...
export const EditProfile = () => {
  ...
  const [photo, changePhoto] = useState<any>(null);
  const [tile, changeTile] = useState<string>("none");
  ...
  return (
    <div className={editProfileStyles.wrapper}>
      {tile === "none" && (
        <>
          <div
            className={editProfileStyles.tile}
            onClick={() => changeTile("avatar")}
          >
            <p>Avatar</p>
            <FaUser />
          </div>
          <div
            className={editProfileStyles.tile}
            onClick={() => changeTile("information")}
          >
            <p>Information</p>
            <FaInfo />
          </div>
        ...
        <>
          <div className={editProfileStyles.avatar}>
            ...
            <div>
              ...
              <button
                className={editProfileStyles.btnAvatar}
                onClick={() => uploadFile()}
              >
                Change
              </button>
      ...
      {tile === "information" && (
        <div className={editProfileStyles.information}>
          <div className={editProfileStyles.info}>
            <div>
              <input maxLength={32} ref={nameRef} />
              Change Name
            </div>
            <div>
              <input maxLength={32} ref={locationRef} />
              Change Location
            </div>
            <div>
              <input maxLength={64} ref={bioRef} />
              Change Bio
            </div>
          </div>
          <div className={editProfileStyles.update}>
            <button
              ...
              className={editProfileStyles.btn}
            >
              Update profile
            </button>
          </div>
