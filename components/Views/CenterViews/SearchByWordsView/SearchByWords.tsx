...
export const SearchByWords = () => {
    ...
    const [usersList, updateUsersList]:Array<any> = useState([])
    ...
    <div className={searchStyles.wrapper}>
        <div className={searchStyles.content}>
            ...
            {displayContent === 'posts' && <Posts requirements={path.query.search} requirementsType="words"/>}
            ...
            <div>
                ...
                <>
                    {usersList.map((user:string) => {
                        return (
                            <FindedUser key={user} username={user}/>
                        )
                    })}
